...
import {
  ...
  createDeliveryPharmacyTenantInstanceController,
...
adminRoutes.post('/instancias/deliverypharmacy', createDeliveryPharmacyTenantInstanceController);
...
adminRoutes.post('/clientes/deliverypharmacy', createDeliveryPharmacyTenantInstanceController);
