...
import {
  ...
  consultDeliveryPharmacyEansController,
...
productRoutes.post('/deliverypharmacy/consultar-eans', authenticateClientApiKey, consultDeliveryPharmacyEansController);
